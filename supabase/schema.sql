...
insert into projects (
  title, category, role, description, image_url, external_url, project_tier, tech_tags, tall, sort_order, feedback_author, feedback_text
) values
  ('Ambience Healthcare', 'Previous role', 'Engineering', 'AI-powered clinical documentation and workflow tools that help clinicians spend less time on the keyboard and more time with patients.', 'https://framerusercontent.com/images/l2jbzG0Wzk7GJYt31m2QzU82JzQ.png', 'https://www.ambiencehealthcare.com/', 'notable', '["Ambient AI","Clinical Documentation","EHR"]', false, 0, 'Maya Thornton, Product Lead', 'Their delivery quality was exceptional. They translated complex clinical workflows into an intuitive experience and consistently hit our milestones.'),
  ('Commure',             'Previous role', 'Engineering', 'Healthcare operations and developer infrastructure — connecting systems so care teams can move faster with safer, more interoperable data.', 'https://cdn.prod.website-files.com/66b319e3933cb4cb9c43ebdc/66cb9c13447baaa8b66e7511_Commure%20-%20Open%20Graph%20Image.jpg', 'https://www.commure.com/', 'notable', '["RCM","Ambient AI","Healthcare Ops"]', true, 1, 'Ethan Brooks, Engineering Manager', 'A strong technical partner from day one. They improved our platform performance and made cross-team integration noticeably smoother.'),
  ('Incuto',              'Previous role', 'Engineering', 'Platform work for community-focused financial services — improving access to fair banking and lending through modern software.', 'https://static1.squarespace.com/static/5c8ad859e8ba4434f9bf43f6/t/5db2fabdca41e03baabf6c71/1572010686772/Incutopurple600.png?format=1500w', 'https://www.incuto.com/', 'notable', '["Fintech","Community Lending","Payments"]', true, 2, 'Sofia Bennett, Head of Product', 'They understood both user needs and regulatory constraints. The final solution was reliable, scalable, and genuinely impactful for our members.'),
  ('Unit21',              'Previous role', 'Engineering', 'Risk and fraud operations tooling — helping teams detect suspicious activity, investigate cases, and stay ahead of financial crime.', 'https://cdn.prod.website-files.com/61e589aa65b0300f0d3e0b70/69adef97057fd6b3d4515fb9_social-opengraph-general.png', 'https://www.unit21.ai/', 'noteworthy', '["Fraud","AML","Risk Infrastructure"]', false, 3, 'Noah Patel, Risk Ops Director', 'Fast iteration, thoughtful architecture, and excellent communication. The tools they built quickly became core to our daily operations.'),
  ('Babyscripts',         'Previous role', 'Engineering', 'Remote pregnancy care — connecting patients and providers with monitoring and education to improve maternal health outcomes.', 'https://babyscripts.com/hubfs/bloodpressure_heroimage.png', 'https://www.babyscripts.com/', 'noteworthy', '["Digital Health","Remote Monitoring","Maternal Care"]', true, 4, 'Olivia Hayes, Clinical Program Owner', 'They delivered with empathy and precision. We saw immediate gains in usability and provider confidence after launch.'),
  ('Panorama Education',  'Previous role', 'Engineering', 'K–12 analytics and surveys — giving schools actionable insight into student success, well-being, and engagement.', 'https://www.panoramaed.com/hubfs/panorama-education-district-view.png', 'https://www.panoramaed.com/', 'noteworthy', '["EdTech","MTSS","Student Analytics"]', false, 5, 'Liam Carter, VP of Data Strategy', 'A dependable collaborator who turned complex requirements into clean, practical product outcomes. Schools loved the clarity of the final workflows.');
