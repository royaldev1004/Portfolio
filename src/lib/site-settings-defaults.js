/**
 * Profile + hero keys for site_settings. Single source for useProfile, ProfileAdmin,
 * and supabase/schema.sql seed (keep values aligned when changing defaults).
 */
export const PROFILE_SITE_SETTINGS_DEFAULTS = {
